...
trigger EPA_StudyLeaveRequest_Trigger on EPA_StudyLeaveRequest__c (after insert, after update) {
    ...
    if (Trigger.isAfter && Trigger.isInsert) {
        ...
        EPA_NotificationService_Class.handleAfterInsert(Trigger.new);
        EPA_BellNotificationService_Class.handleAfterInsert(Trigger.new);
    }
    ...
    if (Trigger.isAfter && Trigger.isUpdate) {
        ...
        EPA_NotificationService_Class.handleAfterUpdate(Trigger.new, Trigger.oldMap);
        EPA_BellNotificationService_Class.handleAfterUpdate(Trigger.new, Trigger.oldMap);
    }
}
